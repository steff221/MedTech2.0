// Страница (Next.js): преглед — дел за матичен лекар (GP).
"use client";
...
export default function GPOverviewPage() {
  const t = useT();
  ...
  const stats = [
    { label: t.doctorOverview.prescriptionsToday, value: data?.prescriptionsToday ?? 0, icon: ClipboardList, color: "bg-teal-50 text-teal-600"      },
