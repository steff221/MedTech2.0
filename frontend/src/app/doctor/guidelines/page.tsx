// Страница (Next.js): упатства — дел за доктор.
"use client";
...
const GUIDELINES = [
  ...
  {
    id: "UP-002",
    title: "Упатство за дијабетес тип 2 — управување",
    category: "Интерна медицина",
    version: "v2.1",
  ...
  {
    id: "UP-003",
    title: "Клинички пат — акутен коронарен синдром",
  ...
  {
    id: "UP-006",
    title: "Процена на болка кај деца — скали и менаџмент",
