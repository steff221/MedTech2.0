...
const INTERACTION_RULES: InteractionRule[] = [
  ...
  },
  {
    ...
    severity: "moderate",
    message: "Левотироксин + калциум/железо/ИПП: намалена апсорпција — препишувај со минимум 4h разлика.",
  },
  {
    drugs: [
      ["digoxin", "дигоксин"],
  ...
  },
  {
    ...
    severity: "high",
    message: "Метотрексат + НСАИЛ: ризик од тешка хематолошка и хепатична токсичност — избегнувај комбинацијата.",
  },
  {
    drugs: [
